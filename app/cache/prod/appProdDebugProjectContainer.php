...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'BmiCalculatorBundle' => 'Bmi\\CalculatorBundle\\BmiCalculatorBundle',
            ),
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Bmi/CalculatorBundle/Entity'))), 'Bmi\\CalculatorBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BmiCalculatorBundle' => 'Bmi\\CalculatorBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_052ea68d787e67571a4a3ad8cf0086cec15d3ae1cb1a17600796325944772473');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Bmi/CalculatorBundle/Resources/views'), 'BmiCalculator');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), (dirname(dirname(__DIR__)).'/../web'), true);
    }
